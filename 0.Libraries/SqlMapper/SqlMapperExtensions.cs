...
//https://github.com/StackExchange/dapper-dot-net/blob/master/Dapper.Contrib/Readme.md
...
public partial class SqlServerAdapter : ISqlAdapter
{
    public int Insert(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, String tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        //update by zhangqian
        var cmd = String.Format("insert into {0} ({1}) values ({2});select SCOPE_IDENTITY()", tableName, columnList, parameterList);

        int id = connection.ExecuteScalar<int>(cmd, entityToInsert, transaction, commandTimeout);
