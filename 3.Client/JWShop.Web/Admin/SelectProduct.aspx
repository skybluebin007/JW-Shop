<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="SelectProduct.aspx.cs" Inherits="JWShop.Web.Admin.SelectProduct" %>
...
<asp:Repeater ID="RecordList" runat="server">
	<ItemTemplate>	     
			...
			<td ><%# ProductClassBLL.ProductClassNameList(Eval("ClassID").ToString())%></td>    
	       	<td ><span onclick="selectThisProduct(<%# Eval("ID") %>,'<%# Eval("Name") %>')" style="cursor:pointer" class="ig-colink">选择</span></td> 	        
		</tr>
     </ItemTemplate>
</asp:Repeater>
    </tbody>
...
<script language="javascript" type="text/javascript">
    function selectThisProduct(productID, productName) {
        var index = parent.layer.getFrameIndex(window.name);
    var tag=getQueryString("Tag");
    parent.dealSelectProduct(productID, productName, tag);
