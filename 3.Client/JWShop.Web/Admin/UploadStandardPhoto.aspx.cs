...
{
    public partial class UploadStandardPhoto : JWShop.Page.AdminBasePage
    {
        ...
        protected void UploadImage(object sender, EventArgs e)
        {
            ...
            if (FileHelper.SafeFullDirectoryName(filePath))
            {
                try
                {
                    ...
                    ResponseHelper.Write("<script>alert('上传成功');  window.parent.o('" + IDPrefix + control + "').value='" + originalFile + "';if(window.parent.o('img_" + control+ "')){window.parent.o('img_" + control + "').src='" + originalFile + "';}</script>");
                    //保存数据库
