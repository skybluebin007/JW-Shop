<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderArea.aspx.cs" Inherits="JWShop.Web.Admin.OrderArea" %>
...
<asp:Content ID="MasterContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">	
    ...
    <div class="container ease" id="container">
        <div class="tab-title">
            ...
            <span class="cur"><a href="OrderArea.aspx">区域分析</a></span>
        </div>
