<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="Pay.aspx.cs" Inherits="JWShop.Web.Admin.Pay" %>
                    ...
                    <asp:Repeater ID="RecordList" runat="server">
	                    <ItemTemplate>
                            <tr>
		                        ...
		                        <td class="link">
		                            <a href="PayAdd.aspx?Key=<%# Eval("Key") %>">修改</a>  
		                        </td>
                            </tr>
	                    </ItemTemplate>
                    </asp:Repeater>
