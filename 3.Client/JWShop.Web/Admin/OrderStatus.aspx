<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="JWShop.Web.Admin.OrderStatusPage" %>
...
<asp:Content ID="MasterContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">	
    ...
    <div class="container ease" id="container">
        <div class="tab-title">
            <span><a href="OrderCount.aspx">数量分析</a></span>
            <span class="cur"><a href="OrderStatus.aspx">状态分析</a></span>
