...
public class FileManager : IHttpHandler
{
	...
	{
        String aspxUrl = "/" + ShopConfig.ReadConfigInfo().FilePath+"/";// context.Request.Path.Substring(0, context.Request.Path.LastIndexOf("/") + 1);
        
		//根目录路径，相对路径
        String rootPath = aspxUrl;
		//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
        String rootUrl = aspxUrl;
		//图片扩展名
