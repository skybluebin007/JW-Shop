            ...
            try
            {
               ...
               //检查邮箱
                ...
                if (msg == string.Empty) {
                    ...
                    string url = "http://" + Request.ServerVariables["HTTP_HOST"] + "/User/BindEmail.html?CheckCode=" + StringHelper.Encode(user.Id + "|" + email + "|" + tempSafeCode, ShopConfig.ReadConfigInfo().SecureKey);
                   ...
                   msg="ok|/User/UpdateEmail.html?Result=" + Server.UrlEncode(result);
